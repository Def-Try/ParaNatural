hook.Add("PopulateToolMenu", "paranatural", function()
    local allow_telekinesis, allow_shield, allow_levitation, allow_dash, allow_inversion
    spawnmenu.AddToolMenuOption("Utilities", "Paranatural", "paranatural_a_settings", "Server Settings", "", "", function(panel)
        ...
        panel:ControlHelp("If unchecked, will limit usage to only admins.")
        allow_inversion = panel:CheckBox("Allow Inversion usage to everyone", "")
        panel:ControlHelp("If unchecked, will limit usage to only admins.")
        ...
        function allow_inversion:OnChange(val) 
            net.Start("paranatural")
                net.WriteUInt(1, 1)
                net.WriteString("paranatural_inversion_allowed")
                net.WriteString(val and "1" or "0")
            net.SendToServer() end
        allow_inversion:SetConVar(nil)
        ...
        net.Start("paranatural") net.WriteUInt(0, 1) net.WriteString("paranatural_inversion_allowed") net.SendToServer()
        ...
        net.Receive("paranatural", function(_, ply)
            ...
            if cv == "paranatural_inversion_allowed" then allow_inversion:SetValue(val) end
        end)
    end)
    spawnmenu.AddToolMenuOption("Utilities", "Paranatural", "paranatural_settings", "Settings", "", "", function(panel)
        ...
        panel:CheckBox("Enable Inversion", "paranatural_inversion_enable")
        panel:ControlHelp("Inversion lets you desync from normal time flow and \"flip\" your time-space orientation")
    end)
    spawnmenu.AddToolMenuOption("Utilities", "Paranatural", "paranatural_binds", "Bindings", "", "", function(panel)
        ...
        panel:KeyBinder("Inversion", "paranatural_inversion_key")
    end)
    ...
    spawnmenu.AddToolMenuOption("Utilities", "Paranatural", "paranatural_sw_forms", "Service Weapon: Forms", "", "", function(panel)
        ...
        panel:ControlHelp("A form that shoots explosives. Can damage owner as well, be careful when using this form.")
        panel:Help("Form #2")
...
CreateClientConVar("paranatural_telekinesis_enable", "1", true, true)
CreateClientConVar("paranatural_shield_enable", "1", true, true)
CreateClientConVar("paranatural_dash_enable", "1", true, true)
CreateClientConVar("paranatural_levitation_enable", "1", true, true)
CreateClientConVar("paranatural_inversion_enable", "1", true, true)
CreateClientConVar("paranatural_weapon_form_1", "grip", true, true)
CreateClientConVar("paranatural_weapon_form_2", "spin", true, true)